...
public class Const {
    ...
    // 学校管理员  学校名称
    public final static String ACADEMY_COLLEGE = "南昌航空大学";
    ...
    public final static String PWD_KEY = "123456";  //加密解密密钥
    
    // 统一注册密码/重置密码
    public final static String UNIFORM_USERPWD = "123456";
    
    // 统一注册状态
    public final static int UNIFORM_STATUS = 1;     //管理员注册的账户初始状态 1激活 0锁定
    public final static int UNIFORM_STATUS_REGISTER = 0;  //学生注册的账户初始状态 1激活 0锁定
    ...
    public final  static String MAIL_ACCOUNT = "";
