    ...
    public static void send_mail(String to, String text) throws MessagingException {
        ...
        Session session = Session.getInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                //两个参数分别是发送邮件的账户和密码
                //return new PasswordAuthentication("911293924@qq.com", "clkduibfzexvbbaj");MAIL_ACCOUNT
                return new PasswordAuthentication(Const.MAIL_ACCOUNT, Const.MAIL_PASSWORD);
            }
        });
        ...
        message.setFrom(new InternetAddress(Const.MAIL_ACCOUNT));
        //设置收件人
        message.setRecipient(Message.RecipientType.TO, new InternetAddress(to));
        //设置主题
        message.setSubject("南昌航空大学创新创业项目管理验证码");
