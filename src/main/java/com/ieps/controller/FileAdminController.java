...
public class FileAdminController {
    ...
    public ServerResponse removeFileById(@RequestParam("userNum") String userNum, HttpSession session, HttpServletRequest request,
        ...
        //String filePath = request.getServletContext().getRealPath("/hub/");原来语句
        String filePath = request.getSession().getServletContext().getRealPath("/hub/"); //现在改为
    ...
    public void downloadFile(String fileName, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            //String ath = request.getServletContext().getRealPath("/hub/")+ fileName;原来语句
            String path = request.getSession().getServletContext().getRealPath("/hub/")+ fileName; //现在改为
    ...
    public ServerResponse onekeyDownloadFile(@RequestParam("userNum") String userNum, @RequestParam("roleId") int roleId,
        ...
        try {
            ...
            //String zipBasePath = request.getServletContext().getRealPath("/hub/");原来语句
            String zipBasePath = request.getSession().getServletContext().getRealPath("/hub/"); //现在改为
