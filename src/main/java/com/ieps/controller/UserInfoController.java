...
public class UserInfoController {
    ...
    public ServerResponse changeUserImg(@RequestParam("file") MultipartFile file, String userNum,
        ...
        if (!file.isEmpty()) {
            ...
            //上传文件路径
            //String storePath = request.getServletContext().getRealPath("/hub/images/"); //原来语句
            String storePath = request.getSession().getServletContext().getRealPath("/hub/images/"); //现在改为
            // 前缀
